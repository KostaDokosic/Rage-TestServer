! function (t) {
    ...
    r.Empty = new r(0, 0, 0, 0), r.Transparent = new r(0, 0, 0, 0), r.Black = new r(0, 0, 0, 255), r.White = new r(255, 255, 255, 255), r.WhiteSmoke = new r(245, 245, 245, 255);
    ...
    class c {
        ...
        Draw(t, e, s, i, n, h, o) {
            t = t || this.TextureDict, e = e || this.TextureName, s = s || this.pos, i = i || this.size, n = n || this.heading, h = h || this.color, (o = o || !0) && (mp.game.graphics.hasStreamedTextureDictLoaded(t) || mp.game.graphics.requestStreamedTextureDict(t, !0));
            const r = 1080 * (l.width / l.height),
                a = this.size.Width / r,
                c = this.size.Height / 1080,
                u = this.pos.X / r + .5 * a,
                d = this.pos.Y / 1080 + .5 * c;
    ...
    class w extends I {
        ...
        Draw(t, e, s, i, n, h, o, r, a) {
            let c = t,
                u = h,
                g = h;
            t || (t = new m(0, 0)), t && !e && (g = this.TextAlignment, c = this.caption, e = new d(this.pos.X + t.Width, this.pos.Y + t.Height), s = this.scale, i = this.color, n = this.font, 1 == u || 0 == u ? u = this.centered : (u = void 0, o = this.DropShadow, r = this.Outline, a = this.WordWrap));
    ...
    class S {
        constructor(t, e = "") {
            this.Id = x(), this.BackColor = S.DefaultBackColor, this.HighlightedBackColor = S.DefaultHighlightedBackColor, this.ForeColor = S.DefaultForeColor, this.HighlightedForeColor = S.DefaultHighlightedForeColor, this.RightLabel = "", this.LeftBadge = h.None, this.RightBadge = h.None, this.Enabled = !0, this._rectangle = new _(new d(0, 0), new m(431, 38), new r(150, 0, 0, 0)), this._text = new w(t, new d(8, 0), .33, r.WhiteSmoke, o.ChaletLondon, p.Left), this.Description = e, this._selectedSprite = new c("commonmenu", "gradient_nav", new d(0, 0), new m(431, 38)), this._badgeLeft = new c("commonmenu", "", new d(0, 0), new m(40, 40)), this._badgeRight = new c("commonmenu", "", new d(0, 0), new m(40, 40)), this._labelText = new w("", new d(0, 0), .35, r.White, 0, p.Right)
        }
        get Text() {
        ...
        SetVerticalPosition(t) {
            this._rectangle.pos = new d(this.Offset.X, t + 144 + this.Offset.Y), this._selectedSprite.pos = new d(0 + this.Offset.X, t + 144 + this.Offset.Y), this._text.pos = new d(8 + this.Offset.X, t + 147 + this.Offset.Y), this._badgeLeft.pos = new d(0 + this.Offset.X, t + 142 + this.Offset.Y), this._badgeRight.pos = new d(385 + this.Offset.X, t + 142 + this.Offset.Y), this._labelText.pos = new d(420 + this.Offset.X, t + 148 + this.Offset.Y)
        }
        addEvent(t, ...e) {
            this._event = {
                event: t,
    ...
    class M extends S {
        ...
        Draw() {
            ...
            this.Selected && t ? this._checkedSprite.TextureName = this.Checked ? "shop_box_tickb" : "shop_box_blankb" : this._checkedSprite.TextureName = this.Checked ? "shop_box_tick" : "shop_box_blank", this._checkedSprite.color = this.Enabled ? this.Selected && !t ? this.HighlightedForeColor : this.ForeColor : new r(163, 159, 148), this._checkedSprite.Draw()
        }
        SetRightBadge(t) {
            return this
        }
    ...
    class D {
        static MeasureStringWidthNoConvert(t) {
            return mp.game.ui.setTextEntryForWidth("STRING"), w.AddLongString(t), mp.game.ui.setTextFont(0), mp.game.ui.setTextScale(.35, .35), mp.game.ui.getTextScreenWidth(!1)
        }
    ...
    class R extends S {
        constructor(t, e = "", s = new O([]), i = 0) {
            ...
            this.Collection = s.getListItems(), this.Index = i, this._arrowLeft = new c("commonmenu", "arrowleft", new d(110, 105), new m(30, 30)), this._arrowRight = new c("commonmenu", "arrowright", new d(280, 105), new m(30, 30)), this._itemText = new w("", new d(290, 104), .35, r.White, o.ChaletLondon, p.Right)
        }
        get Collection() {
        ...
        SetVerticalPosition(t) {
            this._arrowLeft.pos = new d(300 + this.Offset.X + this.Parent.WidthOffset, 147 + t + this.Offset.Y), this._arrowRight.pos = new d(400 + this.Offset.X + this.Parent.WidthOffset, 147 + t + this.Offset.Y), this._itemText.pos = new d(300 + this.Offset.X + this.Parent.WidthOffset, t + 147 + this.Offset.Y), super.SetVerticalPosition(t)
        }
        SetRightLabel(t) {
            return this
        }
        ...
        Draw() {
            ...
            const t = this.Collection.length >= this.Index ? this.Collection[this.Index].DisplayText : " ",
                e = this.currOffset;
            this._itemText.color = this.Enabled ? this.Selected ? this.HighlightedForeColor : this.ForeColor : new r(163, 159, 148), this._itemText.caption = t, this._arrowLeft.color = this.Enabled ? this.Selected ? this.HighlightedForeColor : this.ForeColor : new r(163, 159, 148), this._arrowRight.color = this.Enabled ? this.Selected ? this.HighlightedForeColor : this.ForeColor : new r(163, 159, 148), this._arrowLeft.pos = new d(375 - e + this.Offset.X + this.Parent.WidthOffset, this._arrowLeft.pos.Y), this.Selected ? (this._arrowLeft.Draw(), this._arrowRight.Draw(), this._itemText.pos = new d(405 + this.Offset.X + this.Parent.WidthOffset, this._itemText.pos.Y)) : this._itemText.pos = new d(420 + this.Offset.X + this.Parent.WidthOffset, this._itemText.pos.Y), this._itemText.Draw()
        }
    }
    class b extends S {
        get Index() {
        ...
        constructor(t, e, s, i = "", n = !1) {
            super(t, i);
            this._items = e, this._arrowLeft = new c("commonmenutu", "arrowleft", new d(0, 105), new m(15, 15)), this._arrowRight = new c("commonmenutu", "arrowright", new d(0, 105), new m(15, 15)), this._rectangleBackground = new _(new d(0, 0), new m(150, 9), new r(4, 32, 57, 255)), this._rectangleSlider = new _(new d(0, 0), new m(75, 9), new r(57, 116, 200, 255)), this._rectangleDivider = new _(new d(0, 0), new m(2.5, 20), n ? r.WhiteSmoke : r.Transparent), this.Index = s
        }
        SetVerticalPosition(t) {
            this._rectangleBackground.pos = new d(250 + this.Offset.X + this.Parent.WidthOffset, t + 158.5 + this.Offset.Y), this._rectangleSlider.pos = new d(250 + this.Offset.X + this.Parent.WidthOffset, t + 158.5 + this.Offset.Y), this._rectangleDivider.pos = new d(323.5 + this.Offset.X + this.Parent.WidthOffset, t + 153 + this.Offset.Y), this._arrowLeft.pos = new d(235 + this.Offset.X + this.Parent.WidthOffset, 155.5 + t + this.Offset.Y), this._arrowRight.pos = new d(400 + this.Offset.X + this.Parent.WidthOffset, 155.5 + t + this.Offset.Y), super.SetVerticalPosition(t)
        }
        IndexToItem(t) {
            return this._items[t]
        }
        Draw() {
            super.Draw(), this._arrowLeft.color = this.Enabled ? this.Selected ? r.Black : r.WhiteSmoke : new r(163, 159, 148), this._arrowRight.color = this.Enabled ? this.Selected ? r.Black : r.WhiteSmoke : new r(163, 159, 148);
            let t = (this._rectangleBackground.size.Width - this._rectangleSlider.size.Width) / (this._items.length - 1) * this.Index;
            this._rectangleSlider.pos = new d(250 + this.Offset.X + t + +this.Parent.WidthOffset, this._rectangleSlider.pos.Y), this.Selected && (this._arrowLeft.Draw(), this._arrowRight.Draw()), this._rectangleBackground.Draw(), this._rectangleSlider.Draw(), this._rectangleDivider.Draw()
        }
        SetRightBadge(t) {}
        SetRightLabel(t) {}
    }
    class T extends f {
        ...
        Draw(t) {
            ...
            const e = 1080 * (l.width / l.height),
                ...
                n = (this.pos.X + t.Width) / e + .5 * s,
                h = (this.pos.Y + t.Height) / 1080 + .5 * i;
    ...
    class L {
        constructor(t, e, s, i, n) {
            this.Id = x(), this.counterPretext = "", this.counterOverride = void 0, this.lastUpDownNavigation = 0, this.lastLeftRightNavigation = 0, this._activeItem = 1e3, this.extraOffset = 0, this.WidthOffset = 0, this.Visible = !0, this.MouseControlsEnabled = !1, this._justOpened = !0, this.safezoneOffset = new d(0, 0), this.MaxItemsOnScreen = 9, this._maxItem = this.MaxItemsOnScreen, this.AUDIO_LIBRARY = "HUD_FRONTEND_DEFAULT_SOUNDSET", this.AUDIO_UPDOWN = "NAV_UP_DOWN", this.AUDIO_LEFTRIGHT = "NAV_LEFT_RIGHT", this.AUDIO_SELECT = "SELECT", this.AUDIO_BACK = "BACK", this.AUDIO_ERROR = "ERROR", this.MenuItems = [], this.IndexChange = new u, this.ListChange = new u, this.SliderChange = new u, this.SliderSelect = new u, this.CheckboxChange = new u, this.ItemSelect = new u, this.MenuClose = new u, this.MenuChange = new u, this.MouseEdgeEnabled = !0, s instanceof d || (s = d.Parse(s)), this.title = t, this.subtitle = e, this.spriteLibrary = i || "commonmenu", this.spriteName = n || "interaction_bgd", this.offset = new d(s.X, s.Y), this.Children = new Map, this._mainMenu = new T(new d(0, 0), new m(700, 500), new r(0, 0, 0, 0)), this._logo = new c(this.spriteLibrary, this.spriteName, new d(0 + this.offset.X, 0 + this.offset.Y), new m(431, 107)), this._mainMenu.addItem(this._title = new w(this.title, new d(215 + this.offset.X, 20 + this.offset.Y), 1.15, new r(255, 255, 255), 1, p.Centered)), "" !== this.subtitle && (this._mainMenu.addItem(new _(new d(0 + this.offset.X, 107 + this.offset.Y), new m(431, 37), new r(0, 0, 0, 255))), this._mainMenu.addItem(this._subtitle = new w(this.subtitle, new d(8 + this.offset.X, 110 + this.offset.Y), .35, new r(255, 255, 255), 0, p.Left)), this.subtitle.startsWith("~") && (this.counterPretext = this.subtitle.substr(0, 3)), this._counterText = new w("", new d(425 + this.offset.X, 110 + this.offset.Y), .35, new r(255, 255, 255), 0, p.Right), this.extraOffset += 37), this._upAndDownSprite = new c("commonmenu", "shop_arrows_upanddown", new d(190 + this.offset.X, 147 + 37 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), new m(50, 50)), this._extraRectangleUp = new _(new d(0 + this.offset.X, 144 + 38 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), new m(431, 18), new r(0, 0, 0, 200)), this._extraRectangleDown = new _(new d(0 + this.offset.X, 162 + 38 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), new m(431, 18), new r(0, 0, 0, 200)), this._descriptionBar = new _(new d(this.offset.X, 123), new m(431, 4), r.Black), this._descriptionRectangle = new c("commonmenu", "gradient_bgd", new d(this.offset.X, 127), new m(431, 30)), this._descriptionText = new w("Description", new d(this.offset.X + 5, 125), .35, new r(255, 255, 255, 255), o.ChaletLondon, p.Left), this._background = new c("commonmenu", "gradient_bgd", new d(this.offset.X, 144 + this.offset.Y - 37 + this.extraOffset), new m(290, 25)), mp.events.add("render", this.render.bind(this)), console.log(`Created Native UI! ${this.title}`)
        }
        get CurrentSelection() {
            return this._activeItem % this.MenuItems.length
        }
        set CurrentSelection(t) {
            this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1, this._activeItem = 1e3 - 1e3 % this.MenuItems.length + t, this.CurrentSelection > this._maxItem ? (this._maxItem = this.CurrentSelection, this._minItem = this.CurrentSelection - this.MaxItemsOnScreen) : this.CurrentSelection < this._minItem && (this._maxItem = this.MaxItemsOnScreen + this.CurrentSelection, this._minItem = this.CurrentSelection)
        }
        RecalculateDescriptionPosition() {
            this._descriptionBar.pos = new d(this.offset.X, 112 + this.extraOffset + this.offset.Y), this._descriptionRectangle.pos = new d(this.offset.X, 112 + this.extraOffset + this.offset.Y), this._descriptionText.pos = new d(this.offset.X + 8, 118 + this.extraOffset + this.offset.Y), this._descriptionBar.size = new m(431 + this.WidthOffset, 4), this._descriptionRectangle.size = new m(431 + this.WidthOffset, 30);
            let t = this.MenuItems.length;
            t > this.MaxItemsOnScreen + 1 && (t = this.MaxItemsOnScreen + 2), this._descriptionBar.pos = new d(this.offset.X, 38 * t + this._descriptionBar.pos.Y), this._descriptionRectangle.pos = new d(this.offset.X, 38 * t + this._descriptionRectangle.pos.Y), this._descriptionText.pos = new d(this.offset.X + 8, 38 * t + this._descriptionText.pos.Y)
        }
        SetMenuWidthOffset(t) {
            if (this.WidthOffset = t, null != this._logo && (this._logo.size = new m(431 + this.WidthOffset, 107)), this._mainMenu.Items[0].pos = new d((this.WidthOffset + this.offset.X + 431) / 2, 20 + this.offset.Y), this._counterText && (this._counterText.pos = new d(425 + this.offset.X + t, 110 + this.offset.Y)), this._mainMenu.Items.length >= 2) {
                this._mainMenu.Items[1].size = new m(431 + this.WidthOffset, 37)
            }
        }
        AddItem(t) {
            this._justOpened && (this._justOpened = !1), t.Offset = this.offset, t.Parent = this, t.SetVerticalPosition(25 * this.MenuItems.length - 37 + this.extraOffset), this.MenuItems.push(t), t.Description = this.FormatDescription(t.Description), this.RefreshIndex(), this.RecalculateDescriptionPosition()
        }
        RefreshIndex() {
        ...
        Close() {
            v.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY), this.Visible = !1, this.RefreshIndex(), this.MenuClose.emit()
        }
        GoLeft() {
        ...
        ProcessMouse() {
            ...
            let t = this.MenuItems.length - 1,
                e = 0;
            this.MenuItems.length > this.MaxItemsOnScreen + 1 && (t = this._maxItem), this.IsMouseInBounds(new d(0, 0), new m(30, 1080)) && this.MouseEdgeEnabled ? (mp.game.cam.setGameplayCamRelativeHeading(mp.game.cam.getGameplayCamRelativeHeading() + 5), mp.game.ui.setCursorSprite(6)) : this.IsMouseInBounds(new d(this.GetScreenResolutionMantainRatio().Width - 30, 0), new m(30, 1080)) && this.MouseEdgeEnabled ? (mp.game.cam.setGameplayCamRelativeHeading(mp.game.cam.getGameplayCamRelativeHeading() - 5), mp.game.ui.setCursorSprite(7)) : this.MouseEdgeEnabled && mp.game.ui.setCursorSprite(1);
            for (let i = this._minItem; i <= t; i++) {
                ...
                if (this.IsMouseInBounds(new d(t, n), new m(h, o))) {
                    ...
                    else r.Selected ? !r.Enabled && r.Selected && v.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY) : (this.CurrentSelection = i, v.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY), this.IndexChange.emit(this.CurrentSelection), this.SelectItem())
                } else r.Hovered = !1;
                e++
            }
            ...
            this.MenuItems.length <= this.MaxItemsOnScreen + 1 || (this.IsMouseInBounds(new d(n, i), new m(431 + this.WidthOffset, 18)) ? (this._extraRectangleUp.color = new r(30, 30, 30, 255), (mp.game.controls.isControlJustPressed(0, 24) || mp.game.controls.isDisabledControlJustPressed(0, 24)) && (this.MenuItems.length > this.MaxItemsOnScreen + 1 ? this.GoUpOverflow() : this.GoUp())) : this._extraRectangleUp.color = new r(0, 0, 0, 200), this.IsMouseInBounds(new d(n, i + 18), new m(431 + this.WidthOffset, 18)) ? (this._extraRectangleDown.color = new r(30, 30, 30, 255), (mp.game.controls.isControlJustPressed(0, 24) || mp.game.controls.isDisabledControlJustPressed(0, 24)) && (this.MenuItems.length > this.MaxItemsOnScreen + 1 ? this.GoDownOverflow() : this.GoDown())) : this._extraRectangleDown.color = new r(0, 0, 0, 200))
        }
        ProcessControl() {
        ...
        GoBack() {
            v.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY), this.Visible = !1, null != this.ParentMenu && (this.ParentMenu.Visible = !0, this.ParentMenu._justOpened = !0, this.MenuChange.emit(this.ParentMenu, !1)), this.MenuClose.emit()
        }
        BindMenuToItem(t, e) {
        ...
        render() {
            if (this.Visible) {
                ...
                if (this.MenuItems.length <= this.MaxItemsOnScreen + 1) {
                    ...
                    if (this._extraRectangleUp.size = new m(431 + this.WidthOffset, 18), this._extraRectangleDown.size = new m(431 + this.WidthOffset, 18), this._upAndDownSprite.pos = new d(190 + this.offset.X + this.WidthOffset / 2, 147 + 37 * (this.MaxItemsOnScreen + 1) + this.offset.Y - 37 + this.extraOffset), this._extraRectangleUp.Draw(), this._extraRectangleDown.Draw(), this._upAndDownSprite.Draw(), this._counterText) {
    ...
    exports.Menu = L, exports.UIMenuItem = S, exports.UIMenuListItem = R, exports.UIMenuCheckboxItem = M, exports.UIMenuSliderItem = b, exports.BadgeStyle = h, exports.Point = d, exports.Size = m, exports.Color = r, exports.Font = o, exports.ItemsCollection = O, exports.ListItem = C
}]);